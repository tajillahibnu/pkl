    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xl-5 p-0">
                <div class="login-card login-dark">
                    <div>
                        <div><a class="logo text-start" href="{{ url('/') }}"><img class="img-fluid for-light" src="../assets/images/logo/logo.png" alt="looginpage"><img class="img-fluid for-dark" src="../assets/images/logo/logo_dark.png" alt="looginpage"></a></div>
                        <div class="login-main">
                            <form id="form-login" action="{{ route('auth.do_login') }}" class="theme-form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="email-username" type="email" required="" placeholder="admin@demo.com" value="admin@demo.com">
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label">Password</label>
                                    <div class="form-input position-relative">
                                        <input class="form-control" type="password" name="password" required="" placeholder="*********" value="password">
        ...
        <script>
            ...
            chekAuth = (name) => {
                ...
                APP.axiosRequest({
                    url: `${BASE_URL}/api/auth/do_login`,
                    data: formData,
                }).then(data => {
                    console.log(data)
                }).catch(error => {
